...
export const hitCommand = new SlashCommandBuilder()
  ...
  .addSubcommand((subcommand) => subcommand
    ...
    .setDescription('Manage XP exclusions, status, or a member’s XP.')
...
export const modCommand = new SlashCommandBuilder()
  ...
  .addSubcommand((subcommand) => subcommand
    ...
    .addIntegerOption((option) => option.setName('delete_days').setDescription('Delete 0–7 days of recent messages.').setMinValue(0).setMaxValue(7)))
  .addSubcommand((subcommand) => subcommand
    .setName('unban')
...
export const communityCommand = new SlashCommandBuilder()
  ...
  .addSubcommand((subcommand) => subcommand
    ...
    .setDescription('Add, remove, or set a member’s economy balance.')
